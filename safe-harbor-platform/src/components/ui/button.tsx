  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold tracking-tight ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border/80 bg-white/80 text-foreground shadow-sm hover:bg-primary/5 hover:border-primary/30 hover:text-primary",
        ...
        hero: "hero-gradient text-primary-foreground shadow-elevated hover:opacity-95 font-semibold",
        emergency: "bg-emergency text-emergency-foreground hover:bg-emergency/90 emergency-shadow emergency-pulse font-bold",
        safe: "bg-safe text-safe-foreground hover:bg-safe/90 font-semibold shadow-soft",
      },
      size: {
